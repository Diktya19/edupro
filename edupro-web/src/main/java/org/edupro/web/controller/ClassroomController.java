...
public class ClassroomController extends BaseController {
    ...
    public ModelAndView savePeople(@ModelAttribute("teacher") @Valid CoursePersonRequest request, BindingResult result){
        ...
        try {
            courseService.savePerson(request);
            return new ModelAndView("redirect:/classroom/"+request.getCourseId()+"/people");
        }catch (EduProWebException e){
            addError("course", result,(List<FieldError>)e.getErrors());
            return view;
        }
    ...
    public ModelAndView saveStudent(@ModelAttribute("student") @Valid CourseSiswaRequest request, BindingResult result){
        ModelAndView view = new ModelAndView("pages/classroom/_people-student-add");
        ...
        try {
            courseService.saveSiswa(request);
            return new ModelAndView("redirect:/classroom/"+request.getCourseId()+"/people");
        }catch (EduProWebException e){
            addError("course", result,(List<FieldError>)e.getErrors());
            return view;
