...
public interface CourseService {
    ...
    List<CourseSectionRes> getMaterialByCourseId(String courseId) throws EduProWebException;
    ...
    Optional<CoursePersonResponse> savePerson(CoursePersonRequest request);
}
